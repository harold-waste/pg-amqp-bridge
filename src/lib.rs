...
pub fn start(pool: Pool<PostgresConnectionManager<MakeTlsConnector>>, amqp_uri: &str, bridge_channels: &str, delivery_mode: &u8){
...
fn spawn_listener_publisher(mut pg_conn: PooledConnection<PostgresConnectionManager<MakeTlsConnector>>,
